        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="consultancy-style-one">
                    ...
                    <div class="signle-consultancy mb--30">
                        <div class="icon">
                            <img src="{{ asset('invena/images/about/icons/01.svg') }}" alt="">
                        </div>
                    ...
                    <div class="signle-consultancy">
                        <div class="icon">
                            <img src="{{ asset('invena/images/about/icons/02.svg') }}" alt="">
                        </div>
                        <div class="information">
            ...
            <div class="col-lg-6">
                <div class="thumbnail-business-area-right-two ">
                    <div class="large-thumbnai">
                        <img src="{{ asset('invena/images/about/c1.webp') }}" style="width: 100%; height: 100%;"  alt="">
                    </div>
                    {{-- <div class="small-thumbnail images-r">
                        <img src="{{ asset('invena/images/about/f10.jpg') }}" alt="">
                    </div> --}}
                </div>
            </div>
        </div>
